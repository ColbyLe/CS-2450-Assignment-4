...
public class EventItemListing {
    Image eventImage;
    String name, datetime, description;

    public EventItemListing(int i) {
        switch(i) {
            case 1:
                eventImage = new Image("file:resources/images/event1.png");
                ...
                break;
            case 2:
                eventImage = new Image("file:resources/images/event2.png");
                ...
                break;
            case 3:
                eventImage = new Image("file:resources/images/event3.png");
                name = "Childrens' Story Time";
                datetime = "Saturdays 10:30AM to 11:30AM";
                description = "Do you struggle with parenting? " +
                        "Wish someone else would raise your kids but can't afford daycare? " +
                        "Then PMPL's Childrens' Story Time is the Solution for you!";
                break;
            case 4:
                eventImage = new Image("file:resources/images/event4.png");
